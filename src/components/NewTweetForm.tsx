...
function Form(){
    ...
    return <form onSubmit={handleSubmit} className="flex flex-col gap-2 border-b px-4 py-y">
        <div className="flex gap-4">
            ...
            <textarea ref={inputRef} onChange={e=> setInputValue(e.target.value)} value={inputValue} style={{height: 0}} className="flex-grow resize-none overflow-hidden p-4 text-lg outline-none" placeholder="What's happening"/>
